...
function lib.WriteHolo(ret, holo, scale)
	...
	ret.add(tab..string.format("holoPos(I, entity():toWorld(vec(%.4f, %.4f, %.4f)))\n", pos.x, pos.y, pos.z))
	ret.add(tab..string.format("holoAng(I, entity():toWorld(ang(%.4f, %.4f, %.4f)))\n", ang.p, ang.y, ang.r))
	ret.add(tab..string.format("holoScale(I, vec(%.4f, %.4f, %.4f))\n", scl.x, scl.y, scl.z))
